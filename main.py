...
async def run_createwallets(language: str):
    from scripts.createwallets import run_createwallets as createwallets_run
    await createwallets_run(language)
...
# Danh sách lệnh menu
SCRIPT_MAP = {
    "createwallets": run_createwallets,
    "sendtx": run_sendtx,
    "faucet": run_faucet,
...
def get_available_scripts(language):
    scripts = {
        'vi': [
            ...
            {"name": "2. Send TX │ Octra Testnet", "value": "sendtx"},
